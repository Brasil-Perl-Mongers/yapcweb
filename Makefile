# This Makefile is for the yapcweb extension to perl.
#
...
#     ABSTRACT => q[This is the YAPC::Brasil webserver]
...
#     NAME => q[yapcweb]
#     PL_FILES => {  }
#     PREREQ_PM => { YAML=>q[0], Plack=>q[0], Dancer::Plugin::I18N=>q[0], Dancer::Plugin::Email=>q[0], Authen::SASL=>q[0], Template=>q[0], Test::More=>q[0], LWP::UserAgent=>q[5.8], MIME::Base64=>q[0], HTTP::AcceptLanguage=>q[0], Plack::Request=>q[0], Dancer=>q[0], Net::SMTP::SSL=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/yapcweb.pm]
#     clean => { FILES=>q[yapcweb-*] }
...
TO_INST_PM = lib/yapcweb.pm

PM_TO_BLIB = lib/yapcweb.pm \
	blib/lib/yapcweb.pm
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''This is the YAPC::Brasil webserver'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:' >> META_new.yml
	$(NOECHO) $(ECHO) '  - '\''Felipe da Veiga Leprevost <leprevost@cpan.org>'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'name: yapcweb' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Dancer: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dancer::Plugin::Email: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Dancer::Plugin::I18N: 0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '  Plack: 0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Plack::Request: 0' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "This is the YAPC::Brasil webserver",' >> META_new.json
	$(NOECHO) $(ECHO) '   "author" : [' >> META_new.json
	$(NOECHO) $(ECHO) '      "Felipe da Veiga Leprevost <leprevost@cpan.org>"' >> META_new.json
	$(NOECHO) $(ECHO) '   ],' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "yapcweb",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '            "Dancer" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dancer::Plugin::Email" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "Dancer::Plugin::I18N" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "HTTP::AcceptLanguage" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "LWP::UserAgent" : "5.8",' >> META_new.json
	$(NOECHO) $(ECHO) '            "MIME::Base64" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "Net::SMTP::SSL" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "Plack" : 0,' >> META_new.json
	$(NOECHO) $(ECHO) '            "Plack::Request" : 0,' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>This is the YAPC::Brasil webserver</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>Felipe da Veiga Leprevost &lt;leprevost@cpan.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Authen::SASL" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer::" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer::Plugin::Email" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer::Plugin::I18N" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="HTTP::AcceptLanguage" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="LWP::UserAgent" VERSION="5.8" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/yapcweb.pm blib/lib/yapcweb.pm 
